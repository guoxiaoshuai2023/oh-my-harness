...
Contract identity: `universal-harness-adoption-task-1-contract-20260712-v6`
...
- accepted boundary: `task-docs/history/universal-harness-adoption-20260712/task-1-bundle-compiler/ACCEPTED_CONTRACT_V6.md`, identity `universal-harness-adoption-task-1-contract-20260712-v6`;
- boundary manifest: `task-docs/history/universal-harness-adoption-20260712/task-1-bundle-compiler/TASK1_BOUNDARY_MANIFEST_V6.md`, identity `universal-harness-adoption-task-1-boundary-manifest-20260712-v2`;
- executor launch baseline: `task-docs/history/universal-harness-adoption-20260712/task-1-bundle-compiler/EXECUTOR_LAUNCH_BASELINE_V6.md`, identity `universal-harness-adoption-task-1-executor-launch-baseline-20260712-v2`.

The executor consumes exactly `ACCEPTED_CONTRACT_V6.md`. Existing v4 `ACCEPTED_CONTRACT.md`, manifest, launch baseline, report, QA, and decision remain immutable failed-run evidence.
...
Only files necessary to implement and test the v5 reference-closure correction may change. Unrelated cleanup, module restructuring, schema redesign, package-contract changes, managed-router semantic changes, or test refactoring is outside the boundary.
...
- all v4 failure evidence, v5/v6 contracting artifacts, the revised baseline, and the eventual v6 accepted boundary/manifest/launch baseline
...
Every T1-AC1 through T1-AC11 must be rerun and independently decided under v5. No v4 PASS label is inherited. T1-AC6 additionally requires direct inspection of generated support README, generated-tree and inventory resolution, and every positive/negative fixture below.
...
The test suite must include all of these v5 fixtures:
