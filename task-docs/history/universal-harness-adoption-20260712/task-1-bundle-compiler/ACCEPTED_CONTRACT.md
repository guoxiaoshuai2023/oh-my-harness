...
Contract identity: `universal-harness-adoption-task-1-contract-20260712-v4`
...
2. the following exact generic rules, sorted by descending `from` length and then bytewise ascending `from` for ties:
