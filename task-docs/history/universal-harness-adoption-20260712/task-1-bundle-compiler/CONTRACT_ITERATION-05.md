...
Contract identity: `universal-harness-adoption-task-1-contract-20260712-v5`
...
Exactly these existing candidate roots, frozen by `CONTRACT_STATE_BASELINE_V5.md`:
...
- all v4 failure evidence, v5 contracting artifacts, the revised baseline, and the eventual v5 accepted boundary/manifest/launch baseline
