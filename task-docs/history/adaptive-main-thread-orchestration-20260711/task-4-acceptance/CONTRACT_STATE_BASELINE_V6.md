# Task 4 v6 Contract State Baseline

Identity: `adaptive-main-thread-orchestration-task-4-v6-contract-state-baseline-20260711-v1`

Status: `FROZEN`

Captured: `2026-07-11T22:23:44+08:00`

Worktree: `/Users/yurendao45/Vibe Coding Projects/oh-my-harness-adaptive-main-thread-orchestration`

This baseline freezes the complete failed-v5 working state before Task 4 v6 contract design. Its final SHA-256 is supplied externally after creation. It does not accept or roll back v5 implementation and does not authorize v6 implementation.
...
Complete status before this self-referential baseline was created:
...
The baseline path itself is the only expected addition to that snapshot and becomes protected immediately after creation.

## Complete Untracked Hashes

Exactly 59 untracked files existed before this baseline:
...
Exactly 28 tracked modifications and 59 untracked files were present. Every dirty path is classified; there is no unexplained path.
...
- `README.md`: Task 4 v5 rejected implementation working state; not accepted; eligible only for a future v6 executor.
- `docs/adapters/codex-subagents.md`: Task 1-3 accepted implementation path; protected/read-only.
- `docs/adoption/router-refactor-runbook.md`: Task 4 v5 rejected implementation working state; not accepted; eligible only for a future v6 executor.
...
- `docs/architecture.md`: Task 4 v5 rejected implementation working state; not accepted; eligible only for a future v6 executor.
- `examples/minimal-router/AGENTS.md`: Task 4 v5 rejected implementation working state; not accepted; eligible only for a future v6 executor.
- `task-docs/_harness/adaptive-orchestration-acceptance-matrix.md`: Task 4 v5 rejected implementation working state; not accepted; eligible only for a future v6 executor.
- `task-docs/_harness/adaptive-orchestration-protocol.md`: Task 1-3 accepted implementation path; protected/read-only.
- `task-docs/_harness/evaluator-calibration.md`: Task 4 v5 rejected implementation working state; not accepted; eligible only for a future v6 executor.
...
- `task-docs/_harness/templates/routing-scenario-matrix-template.md`: Task 4 v5 rejected implementation working state; not accepted; eligible only for a future v6 executor.
...
- `task-docs/adaptive-main-thread-orchestration-accepted-planning-inputs-20260711.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/adaptive-main-thread-orchestration-implementation-task-plan-20260711.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/adaptive-main-thread-orchestration-plan-review-20260711.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/adaptive-main-thread-orchestration-plan-review-pass-a-20260711.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/adaptive-main-thread-orchestration-planning-delivery-report-20260711.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-1-control-plane/ACCEPTED_CONTRACT.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-1-control-plane/CONTRACT_ITERATION-01.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-1-control-plane/CONTRACT_ITERATION-02.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-1-control-plane/CONTRACT_ITERATION-03.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-1-control-plane/CONTRACT_REVIEW.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-1-control-plane/IMPLEMENTATION_REPORT.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-1-control-plane/MAIN_THREAD_ACCEPTANCE.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-1-control-plane/RESULT_QA.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-1-control-plane/TASK1_BOUNDARY_MANIFEST.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-2-artifacts/ACCEPTED_CONTRACT.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-2-artifacts/CONTRACT_ITERATION-01.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-2-artifacts/CONTRACT_ITERATION-02.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-2-artifacts/CONTRACT_ITERATION-03.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-2-artifacts/CONTRACT_REVIEW.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-2-artifacts/CONTRACT_REVIEW_ITERATION-01.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-2-artifacts/CONTRACT_REVIEW_ITERATION-02.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-2-artifacts/EXECUTOR_LAUNCH_BASELINE.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-2-artifacts/IMPLEMENTATION_REPORT.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-2-artifacts/MAIN_THREAD_ACCEPTANCE.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-2-artifacts/RESULT_QA.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-2-artifacts/TASK2_BOUNDARY_MANIFEST.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-3-profiles/ACCEPTED_CONTRACT.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-3-profiles/CONTRACT_ITERATION-01.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-3-profiles/CONTRACT_ITERATION-02.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-3-profiles/CONTRACT_REVIEW.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-3-profiles/CONTRACT_REVIEW_ITERATION-01.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-3-profiles/EXECUTOR_LAUNCH_BASELINE.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-3-profiles/IMPLEMENTATION_REPORT.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-3-profiles/MAIN_THREAD_ACCEPTANCE.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-3-profiles/RESULT_QA.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-3-profiles/TASK3_BOUNDARY_MANIFEST.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-4-acceptance/ACCEPTED_CONTRACT.md`: frozen Task 4 v5 contract, review, baseline, report, QA, manifest, or failure-routing artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-4-acceptance/CONTRACT_ITERATION-01.md`: frozen Task 4 v5 contract, review, baseline, report, QA, manifest, or failure-routing artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-4-acceptance/CONTRACT_ITERATION-02.md`: frozen Task 4 v5 contract, review, baseline, report, QA, manifest, or failure-routing artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-4-acceptance/CONTRACT_ITERATION-03.md`: frozen Task 4 v5 contract, review, baseline, report, QA, manifest, or failure-routing artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-4-acceptance/CONTRACT_ITERATION-04.md`: frozen Task 4 v5 contract, review, baseline, report, QA, manifest, or failure-routing artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-4-acceptance/CONTRACT_ITERATION-05.md`: frozen Task 4 v5 contract, review, baseline, report, QA, manifest, or failure-routing artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-4-acceptance/CONTRACT_REVIEW.md`: frozen Task 4 v5 contract, review, baseline, report, QA, manifest, or failure-routing artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-4-acceptance/CONTRACT_REVIEW_ITERATION-01.md`: frozen Task 4 v5 contract, review, baseline, report, QA, manifest, or failure-routing artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-4-acceptance/CONTRACT_REVIEW_ITERATION-02.md`: frozen Task 4 v5 contract, review, baseline, report, QA, manifest, or failure-routing artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-4-acceptance/CONTRACT_REVIEW_ITERATION-03.md`: frozen Task 4 v5 contract, review, baseline, report, QA, manifest, or failure-routing artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-4-acceptance/CONTRACT_REVIEW_ITERATION-04.md`: frozen Task 4 v5 contract, review, baseline, report, QA, manifest, or failure-routing artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-4-acceptance/CONTRACT_REVIEW_ITERATION-05.md`: frozen Task 4 v5 contract, review, baseline, report, QA, manifest, or failure-routing artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-4-acceptance/CONTRACT_STATE_BASELINE.md`: frozen Task 4 v5 contract, review, baseline, report, QA, manifest, or failure-routing artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-4-acceptance/EXECUTOR_LAUNCH_BASELINE.md`: frozen Task 4 v5 contract, review, baseline, report, QA, manifest, or failure-routing artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-4-acceptance/IMPLEMENTATION_REPORT.md`: frozen Task 4 v5 contract, review, baseline, report, QA, manifest, or failure-routing artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-4-acceptance/RESULT_QA.md`: frozen Task 4 v5 contract, review, baseline, report, QA, manifest, or failure-routing artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-4-acceptance/TASK4_BOUNDARY_MANIFEST.md`: frozen Task 4 v5 contract, review, baseline, report, QA, manifest, or failure-routing artifact; protected/read-only.
- `task-docs/history/adaptive-main-thread-orchestration-20260711/task-4-acceptance/TASK4_V5_FAILURE_DECISION.md`: frozen Task 4 v5 contract, review, baseline, report, QA, manifest, or failure-routing artifact; protected/read-only.
- `task-docs/main-thread-control-enhancement-requirements-20260711.md`: pre-existing frozen planning/upstream evidence or run artifact; protected/read-only.

## Rejected v5 Implementation Before State

These seven paths are retained without rollback and are not accepted. They are the only possible v6 implementation write candidates.
...
Exactly 26 accepted paths remain protected and byte-identical:
...
Exactly 12 accepted evidence artifacts remain protected and byte-identical:
...
The 93 entries below include the complete v5 launch protected inventory, all failed-run/contract artifacts now present, the v5 launch baseline itself, the release checklist, and the example README. The seven rejected v5 implementation paths are excluded because they are potential v6 write candidates.
...
This baseline is protected after creation and omitted from its recursive inventory. Its external final SHA closes the reference.

## Contracting Decision

- Task 4 v5 remains failed and unaccepted.
- Task 1-3 no-impact is established by 26 accepted implementation hashes, 12 accepted evidence hashes, and the correct deliberate-selection authority already present in the protected adaptive protocol.
- No v5 implementation path was rolled back or accepted.
- Staged and committed deltas are empty.
- Only contract/failure/baseline/review artifacts may be created during v6 contracting.
- Any mismatch or unexplained path stops v6 contracting without repair.
